...
![](/assets/img/Pasted image 20260201181017.png)
第一次访问会进入jpress的安装向导

配置好安装信息即可，jpress会自动创建数据库表
![](/assets/img/Pasted image 20260201181146.png)

网站内容设置以及管理员账户设置
![](/assets/img/Pasted image 20260201181326.png)

访问jpress首页，http://ip:8080/jpress/
![](/assets/img/Pasted image 20260201181744.png)
