...
安装完成后点击关闭
![](/assets/img/Pasted image 20260131025231.png)

可以使用cmd键入java --version检查安装是否成功，显示具体信息代表成功
![](/assets/img/Pasted image 20260131025409.png)
...
![](/assets/img/Pasted image 20260131032032.png)
...
你应该看到输出了jdk的安装目录
![](/assets/img/Pasted image 20260131032229.png)
...
启动tomcat
执行startup.bat
![](/assets/img/Pasted image 20260131032502.png)


访问tomcat默认网站

打开浏览器输入http://127.0.0.1:8080
![](/assets/img/Pasted image 20260131032535.png)
看到这个页面代表部署tomcat成功
