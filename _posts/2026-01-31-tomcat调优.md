...
tomcat-native-1.3.4-src.tar.gz（注意兼容） ： 关联tomcat和apr的组件
...
2.4、安装tomcat-native
```
tar xf tomcat-native-1.3.4-src.tar.gz
cd tomcat-native-1.3.4-src/native/
...
![](/assets/img/Pasted image 20260205012427.png)
